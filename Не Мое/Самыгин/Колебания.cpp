...
#define ID_MAINFREQ 2
#define ID_ATTCONST 3
#define ID_PWAMPLIT 4
#define ID_PWFREQUE 5
...
#define ID_STARTPOS 14
#define ID_LINEINF1 15
#define ID_LINEINF2 16
#define ID_LINEINF3 17
#define ID_GRAFINF1 18
#define ID_GRAFINF2 19
#define ID_GRAFINF3 20



float v = 0, t = 0, x = 0, xn = 0, vn = 0;
float k1, k2, k3, k4, k1n, k2n, k3n, k4n;
float g = 0, a = 0, w1 = 0, w2 = 0, v0 = 0, x0 = 0;
...
int WINAPI WinMain(HINSTANCE hInst,HINSTANCE,LPSTR,int ss) {
 ...
 HWND hMainWnd = CreateWindow("Example 4 MainWnd Class","Model graph",WS_OVERLAPPEDWINDOW,
  CW_USEDEFAULT,CW_USEDEFAULT,740,480,NULL,NULL,hInst,NULL);
